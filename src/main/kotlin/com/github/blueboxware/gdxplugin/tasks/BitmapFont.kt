...
open class BitmapFont: DefaultTask() {
  ...
  fun generate() {
    ...
    val cpConfiguration = project.buildscript.configurations.findByName("classpath") ?: throw GradleException("Could not find classpath configuration of buildscript")
